...
namespace WindowsFormsApp2
{
    class DataLayer
    {
        ...
        public void ExecuteProcedureNoReturn(string ProcedureName, object[,] Parameters = null)
        {
            ...
            if (IsValid)
            {
                ...
                for (int i = 0; i < Parameters.GetLength(0); i++)
                    com.Parameters.Add(new SqlParameter(Parameters[0, i].ToString(), Parameters[1, i]));
                con.Open();
                try
                {
                    com.ExecuteNonQuery();
